package net.mcreator.moblootbags;
...
import net.mcreator.moblootbags.init.MobLootBagsModTabs;
import net.mcreator.moblootbags.init.MobLootBagsModMenus;
import net.mcreator.moblootbags.init.MobLootBagsModItems;
import net.mcreator.moblootbags.init.MobLootBagsModBlocks;
...
public class MobLootBagsMod {
	...
	public MobLootBagsMod() {
		...
		MobLootBagsModItems.REGISTRY.register(bus);
