...
public class LootbagOpenBlockGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LootbagOpenBlockGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 17, 17) {
			...
			private int x = LootbagOpenBlockGUIMenu.this.x;
			private int y = LootbagOpenBlockGUIMenu.this.y;
		}));
