package tn.naizo.moblootbags;

import tn.naizo.moblootbags.init.*;
...
public class MobLootBagsMod {
	...
	public MobLootBagsMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		MobLootBagsModSounds.REGISTRY.register(modEventBus);
		MobLootBagsModBlocks.REGISTRY.register(modEventBus);
		MobLootBagsModBlockEntities.REGISTRY.register(modEventBus);
		MobLootBagsModItems.REGISTRY.register(modEventBus);
		MobLootBagsModTabs.REGISTRY.register(modEventBus);
		MobLootBagsModMenus.REGISTRY.register(modEventBus);
