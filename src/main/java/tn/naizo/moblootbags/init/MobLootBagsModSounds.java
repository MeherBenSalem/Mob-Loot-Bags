...
public class MobLootBagsModSounds {
	...
	public static final RegistryObject<SoundEvent> LOOTBAG_SFX_1 = REGISTRY.register("lootbag_sfx_1", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("mob_loot_bags", "lootbag_sfx_1")));
	public static final RegistryObject<SoundEvent> LOOTBAG_SFX_2 = REGISTRY.register("lootbag_sfx_2", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("mob_loot_bags", "lootbag_sfx_2")));
}
