...
import tn.naizo.moblootbags.item.UnknowChestItem;
...
public class MobLootBagsModItems {
	...
	public static final RegistryObject<Item> UNKNOW_CHEST = REGISTRY.register("unknow_chest", () -> new UnknowChestItem());
